          ...
          <form onSubmit={handleSimulationRequest} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="md:col-span-3">
              ...
              <button
                ...
                className="w-full md:w-auto bg-[#0d2233] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#79b2e9] transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
