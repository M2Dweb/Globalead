      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <aside className="space-y-6">
          ...
          <div className="mt-6 flex justify-center">
            <Link
              to="/blog"
              className="bg-white text-[#0d2233] border border-[#0d2233] py-2 px-6 rounded-lg hover:bg-[#79b2e9] hover:text-white hover:border-[#79b2e9] transition-colors text-center font-medium inline-block"
            >
              Ver mais →
            </Link>
          </div>
